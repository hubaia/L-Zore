 ...
 */
export const PhaserLZorePage: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900">
            ...
            <div className="container mx-auto px-4 py-6">
                ...
                {/* 操作说明 */}
                <div className="mt-8 bg-black bg-opacity-50 rounded-lg p-6 text-white">
                    <h3 className="text-xl font-bold mb-4 text-center">🎯 操作指南</h3>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            <h4 className="font-bold text-blue-400 mb-3">基础操作</h4>
                            <ul className="space-y-2 text-sm text-gray-300">
                                <li><span className="text-green-400">🖱️ 拖拽卡牌</span> - 直接拖拽到战场格子</li>
                                <li><span className="text-blue-400">💫 悬停效果</span> - 鼠标悬停查看卡牌详情</li>
                                <li><span className="text-purple-400">🎭 神煞激活</span> - 放置卡牌后自动触发特效</li>
                                <li><span className="text-orange-400">⚡ 流畅动画</span> - 享受丝滑的操作体验</li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-300">
                                ...
                                <li><span className="text-indigo-400">🎵 音效系统</span> - 沉浸式听觉体验</li>
                            </ul>
                        </div>
                    </div>
                </div>
