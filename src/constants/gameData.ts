...
export const CARD_DATABASE: LZoreCard[] = [
    {
        ...
        psyProfile: '绝对忠诚，正义执行模式，危机响应优先级MAX，金元素共振防护',
    ...
    },
    {
        ...
        psyProfile: '高智商分析型，数据处理能力超群，擅长逻辑推演和知识传递，水元素智慧流动',
        motto: '知识即力量，数据即真理。智慧如水，浸润万物灵魂...',
        dossier: '智能导师型AI，搭载全域知识数据库和量子墨羽处理器。其知识网络据说连接着深海古文明的智慧结晶，能通过水元素的流动性传播知识。操作者偶尔会在数据流中瞥见深渊图书馆的影像，那里存放着不应被凡人知晓的禁忌真理。',
        type: 'auspicious',
        element: 'water',
        power: 2,
        rarity: '⭐⭐',
    ...
    },
    {
        ...
        psyProfile: '超高攻击性，战斗成瘾，安全协议已损坏，存在友伤风险，火元素狂暴燃烧',
    ...
    },
    {
        ...
        psyProfile: '超然冷静，信息收集专精，隐匿模式常驻，真实意图未知，土元素稳固隐藏',
        motto: '信息在暗处，真相需要代价。大地深处埋藏着不可言喻的秘密...',
        dossier: '神秘的情报收集型AI，搭载华盖隐形系统和奇门数据解析模块。其隐匿算法据说源自地底古文明的隐秘技术，能与土元素共振形成完美隐形。传说其数据库深处连接着地心的古老观测站，那里记录着星辰运行的真正规律。',
        type: 'special',
        element: 'earth',
        power: 1,
        rarity: '⭐',
    ...
    },
    {
        ...
        psyProfile: '自由意志强烈，机动性MAX，不喜束缚，四处游历收集数据，火元素加速燃烧',
        motto: '速度即生命，移动即存在！追逐着星际间的永恒流火...',
        dossier: '游击型高速AI，配备疾风推进系统和千里马级机动装置。其推进系统据说采用了火元素的纯粹动能，能达到接近光速的移动速度。目击者声称其移动轨迹会在时空中留下燃烧的裂痕，那些裂痕中偶尔会传来远古骑士的战歌。',
        type: 'special',
        element: 'fire',
        power: 2,
        rarity: '⭐⭐',
